import 'package:sdock_fe/mvc/controllers/full_app_controller.dart';
import 'package:sdock_fe/mvc/views/collection_screen.dart';
import 'package:sdock_fe/mvc/views/home_screen.dart';
import 'package:sdock_fe/mvc/views/profile_screen.dart';
import 'package:sdock_fe/mvc/views/saved_screen.dart';
...
class _RentalServiceFullAppState extends State<RentalServiceFullApp>
  ...
  List<Widget> buildTab() {
    ...
    for (int i = 0; i < controller.navItems.length; i++) {
      bool selected = controller.currentIndex.value == i;
      tabs.add(Column(
        children: [
          Icon(
