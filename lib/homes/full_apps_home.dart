import 'package:sdock_fe/full_apps/animations/nft/views/splash_screen.dart'
    as nft;
import 'package:sdock_fe/mvc/views/splash_screen.dart'
    as rental_service;
import 'package:sdock_fe/full_apps/animations/shopping/views/splash_screen.dart'
    as shopping;
import 'package:sdock_fe/full_apps/animations/shopping_manager/views/login_screen.dart'
    as shopping_manager;
import 'package:sdock_fe/full_apps/m3/cookify/views/splash_screen.dart'
    as cookify;
import 'package:sdock_fe/full_apps/m3/dating/views/splash_screen.dart' as dating;
import 'package:sdock_fe/full_apps/m3/estate/views/splash_screen.dart' as estate;
import 'package:sdock_fe/full_apps/m3/homemade/views/splash_screen.dart'
    as homemade;
import 'package:sdock_fe/full_apps/m3/learning/views/splash_screen.dart'
    as learning;
import 'package:sdock_fe/full_apps/other/cookify/views/splash_screen.dart';
import 'package:sdock_fe/full_apps/other/dating/views/splash_screen.dart';
import 'package:sdock_fe/full_apps/other/estate/views/splash_screen.dart';

import 'package:sdock_fe/full_apps/other/grocery/full_app.dart';
import 'package:sdock_fe/full_apps/other/medicare/splash_screen.dart';
import 'package:sdock_fe/full_apps/other/muvi/views/splash_screen.dart' as muvi;
import 'package:sdock_fe/full_apps/other/shopping/full_app.dart';
