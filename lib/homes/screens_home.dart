import 'package:sdock_fe/apps/auth/forgot_password1_screen.dart';
import 'package:sdock_fe/apps/auth/forgot_password2_screen.dart';
import 'package:sdock_fe/apps/auth/login1_screen.dart';
import 'package:sdock_fe/apps/auth/login2_screen.dart';
import 'package:sdock_fe/apps/auth/login_register_screen.dart';
import 'package:sdock_fe/apps/auth/otp_verification_screen.dart';
import 'package:sdock_fe/apps/auth/register1_screen.dart';
import 'package:sdock_fe/apps/auth/register2_screen.dart';
import 'package:sdock_fe/apps/chat/chat_facebook_page.dart';
import 'package:sdock_fe/apps/chat/chat_home_screen.dart';
import 'package:sdock_fe/apps/chat/chat_whatsapp_page.dart';
import 'package:sdock_fe/apps/course/course_full_app.dart';
import 'package:sdock_fe/apps/dashboard/lms_dashboard_screen.dart';
import 'package:sdock_fe/apps/dashboard/seller_dashboard_screen.dart';
import 'package:sdock_fe/apps/event/event_full_app.dart';
import 'package:sdock_fe/apps/food/food_on_boarding_screen.dart';
import 'package:sdock_fe/apps/handyman/handyman_full_app.dart';
import 'package:sdock_fe/apps/health/health_full_app.dart';
import 'package:sdock_fe/apps/hotel/hotel_login_screen.dart';
import 'package:sdock_fe/apps/hotel/hotel_onboarding_screen.dart';
import 'package:sdock_fe/apps/hotel/hotel_password_screen.dart';
import 'package:sdock_fe/apps/hotel/hotel_profile_screen.dart';
import 'package:sdock_fe/apps/hotel/hotel_register_screen.dart';
import 'package:sdock_fe/apps/mail/mail_home_screen.dart';
import 'package:sdock_fe/apps/music/music_login_screen.dart';
import 'package:sdock_fe/apps/music/music_onboarding_screen.dart';
...
import 'package:sdock_fe/apps/news/news_categery_screen.dart';
import 'package:sdock_fe/apps/other/about_app_screen.dart';
import 'package:sdock_fe/apps/other/empty_cart_screen.dart';
import 'package:sdock_fe/apps/other/faq_question_screen.dart';
import 'package:sdock_fe/apps/other/maintenance_screen.dart';
import 'package:sdock_fe/apps/other/no_internet_screen.dart';
import 'package:sdock_fe/apps/other/page_not_found_screen.dart';
import 'package:sdock_fe/apps/other/product_sold_out_screen.dart';
import 'package:sdock_fe/apps/other/terms_screen.dart';
import 'package:sdock_fe/apps/profile/company_profile_screen.dart';
import 'package:sdock_fe/apps/profile/edit_profile_screen.dart';
import 'package:sdock_fe/apps/profile/profile_screen.dart';
import 'package:sdock_fe/apps/quiz/quiz_customize_screen.dart';
import 'package:sdock_fe/apps/quiz/quiz_question_type1_screen.dart';
import 'package:sdock_fe/apps/quiz/quiz_question_type2_screen.dart';
import 'package:sdock_fe/apps/setting/account_setting_screen.dart';
import 'package:sdock_fe/apps/setting/basic_setting_screen.dart';
import 'package:sdock_fe/apps/setting/notification_setting_screen.dart';
import 'package:sdock_fe/apps/setting/privacy_security_setting_screen.dart';
import 'package:sdock_fe/apps/shopping/shopping_login_screen.dart';
import 'package:sdock_fe/apps/shopping/shopping_onboarding_screen.dart';
import 'package:sdock_fe/apps/shopping/shopping_password_screen.dart';
import 'package:sdock_fe/apps/shopping/shopping_profile_screen.dart';
import 'package:sdock_fe/apps/shopping/shopping_register_screen.dart';
import 'package:sdock_fe/apps/social/social_full_app.dart';
import 'package:sdock_fe/apps/wallet/wallet_crypto_screen.dart';
import 'package:sdock_fe/apps/wallet/wallet_home_screen.dart';
import 'package:sdock_fe/apps/wallet/wallet_payment_screen.dart';
